...
/**
 * INVOICE TEMPLATE - Browser Print Version
        ...
        <div class="info-section">
            ...
            <div class="info-box right">
                ...
                <div style="margin-top: 10px;">
                    ...
                    $status_class = in_array($status, ['settlement', 'capture']) ? 'status-success' : 'status-pending';
                    $status_text = in_array($status, ['settlement', 'capture']) ? 'LUNAS' : 'PENDING';
                    ?>

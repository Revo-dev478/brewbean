...
// Proses form ketika tombol "Send Message" diklik
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  // Contoh proses kirim email (opsional)
  // mail($to, $subject, $message, "From: $email");

  $success_message = "Terima kasih, $name! Pesan kamu sudah kami terima.";
}
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  <title>Contact | Coffee Blend</title>
  <meta charset="utf-8">
